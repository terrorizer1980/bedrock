...
class TestVPNSubscribeLink(TestCase):
    ...
    def test_vpn_subscribe_link(self):
        ...
        markup = self._render(entrypoint='www.mozilla.org-vpn-product-page', link_text='Get Mozilla VPN',
                              class_name='mzp-c-button js-get-vpn',
                              optional_parameters={'utm_campaign': 'vpn-product-page'},
                              optional_attributes={'data-cta-text': 'Get Mozilla VPN', 'data-cta-type':
        ...
        expected = (
            ...
            u'class="js-fxa-cta-link js-fxa-product-button mzp-c-button js-get-vpn" '
            u'data-cta-text="Get Mozilla VPN" data-cta-type="fxa-vpn" data-cta-position="primary">'
            u'Get Mozilla VPN</a>')
